...
beforeEach(function (): void {)
    ...
    $no_super_admin_user = $this->getNoSuperAdminUser();
});
...
it('user admin can view main dashboard', function (): void {)
    ...
    $this->actingAs($this->super_admin_user; // ->assertSee($modules_name));
});

it('guest user can view main dashboard', function (): void {)
    $this->actingAs($this->no_super_admin_user);
    $this->actingAs($this->no_super_admin_user);
});
...
it('user admin can view module dashboard', function (): void {)
    ...
    // $this->actingAs($super_admin_user);
    $this->actingAs($this->super_admin_user; // ->assertSee($modules_name));
})->todo();
