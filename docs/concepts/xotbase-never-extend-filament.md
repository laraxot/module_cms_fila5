---
title: "Cms — mai Filament\*, sempre XotBase*"
type: concept
module: Cms
tags: [cms, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Cms filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Cms` estende una classe `Filament\...` direttamente.
