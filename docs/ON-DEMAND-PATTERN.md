---
title: "On-Demand Pattern — Module Cms"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
| Ricerca locale | `qmd search "topic" -c Cms` |
| Wiki locale | `Read ./laravel/Modules/Cms/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/Cms/docs/wiki/log.md
