...
paths:
  include:
    ...
    - ./laravel/Modules/Cms/docs/wiki/**/*.md  # ← Questo modulo
```
...
```bash
qmd search "<topic>" -c Cms
# Cerca solo in ./laravel/Modules/Cms/docs/wiki/
```
...
```bash
qmd search "form" -c Cms   # Solo questo modulo
```
...
| Ricerca lenta | Limita con `-c Cms` |
