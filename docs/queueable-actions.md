---
title: "Queueable Actions — Cms Module"
type: concept
created: 2026-07-12
updated: 2026-07-12
confidence: high
tags: [queueable-action, spatie, architecture, laraxot, cms]
related:
  - Modules/Xot/docs/queueable-actions.md
---

# Queueable Actions — Cms Module Doctrine
...
```bash
cd laravel
php -d memory_limit=2048M vendor/bin/phpstan analyse Modules/Cms --no-progress
vendor/bin/pint Modules/Cms/app/Actions
```
