---
title: "Composer root minimale — modulo Cms"
type: concept
tags: [composer, cms, nwidart, merge-plugin]
created: 2026-06-29
updated: 2026-06-29
qmd: "Cms composer dependencies root minimal nwidart merge-plugin"
issues:
...
# Cms e composer root minimale

## Regola

Dipendenze del dominio **Cms** in `Modules/Cms/composer.json`. Il root `laravel/composer.json` resta skeleton; riferimento FixCity con debito noto — canonico Predict in [composer-root-minimal-nwidart](../../../../../../docs/wiki/concepts/composer-root-minimal-nwidart.md).
