...
type: concept
module: Cms
tags: [cms, services, support, actions, queueable-action, migration]
created: 2026-07-13
updated: 2026-07-13
qmd: "Cms module Services and Support banned use app Actions QueueableAction policy"
related:
  - no-app-support-queueable-actions.md
  - ../../../Xot/docs/wiki/concepts/queueable-action-trait-mandatory.md
---

# Cms — Services/Support vietati: solo Actions
