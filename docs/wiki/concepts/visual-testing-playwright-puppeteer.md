---
title: Visual Testing con Playwright e Puppeteer — Modulo Cms
type: concept
sources:
...
created: 2026-05-04
updated: 2026-05-04
tags: [visual-testing, playwright, puppeteer, e2e, screenshot, laravel, Cms]
related:
  - playwright-testing-policy
---

# Visual Testing con Playwright e Puppeteer — Modulo Cms
...
I test Playwright del modulo Cms appartengono a:

```
laravel/Modules/Cms/tests/Playwright/
```
...
```javascript
// laravel/Modules/Cms/tests/Playwright/visual-regression.spec.js
import { test, expect } from '@playwright/test';

test('Cms UI renders correctly', async ({ page }) => {
    await page.goto('/it/...');
    await page.waitForLoadState('networkidle');
    await expect(page).toHaveScreenshot('Cms-initial.png', {
